...
import hust.soict.hespi.aims.screen.customer.view.ItemController;
    ...
    public void initialize() {
        ...
        for (int i = 0; i < store.getItemsInStore().size(); i++) {
            try {
                ...
                fxmlLoader.setLocation(getClass().getResource("/hust/soict/hespi/aims/screen/customer/view/Item.fxml"));
